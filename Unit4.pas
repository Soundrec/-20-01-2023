...
procedure TMainFormAdmin.ButtonSetImageClick(Sender: TObject);
begin
...
procedure TMainFormAdmin.B_search_actor_phoneClick(Sender: TObject);
var
 s:string;
begin
  s := application.title;
...
procedure TMainFormAdmin.B_search_date_timeClick(Sender: TObject);
var
 quest:string;
 s:string;
begin
...
procedure TMainFormAdmin.B_Search_phoneClick(Sender: TObject);
var
 s:string;
begin
  s := application.title;
...
procedure TMainFormAdmin.ButtonAddBookingClick(Sender: TObject);
begin
  Form3.ShowModal;
  DataModule2.Q_view_booking_full_info.Requery;
  LabelRecCount.Caption :='Отображено записей: '+inttostr(DataModule2.Q_view_booking_full_info.RecordCount);
...
procedure TMainFormAdmin.CheckBox1Click(Sender: TObject);
begin
 // Отключение фильтра
...
procedure TMainFormAdmin.CheckBox2Click(Sender: TObject);
begin
  DataModule2.Q_view_booking_full_info.Close;
...
procedure TMainFormAdmin.ChkCostFilterClick(Sender: TObject);
var
...
procedure TMainFormAdmin.ComboCostConditionChange(Sender: TObject);
begin
ChkCostFilterClick(nil);
end;

procedure TMainFormAdmin.DateTimePicker1Change(Sender: TObject);
begin
CheckBox1Click(nil);
end;

procedure TMainFormAdmin.DateTimePicker2Change(Sender: TObject);
begin
CheckBox1Click(nil);
end;
...
procedure TMainFormAdmin.DBGrid1DrawColumnCell(Sender: TObject; const Rect: TRect;
  DataCol: Integer; Column: TColumn; State: TGridDrawState);
...
procedure TMainFormAdmin.DBGrid1TitleClick(Column: TColumn);
var
  new_field:integer;
  temp: string;
...
procedure TMainFormAdmin.DBGrid2TitleClick(Column: TColumn);
var
  new_field:integer;
  temp: string;
begin
...
procedure TMainFormAdmin.E_FilterChange(Sender: TObject);
var
 baseSQL, filter_s: string;
begin
...
procedure TMainFormAdmin.N2Click(Sender: TObject);
begin
 Form8.Show();
end;

procedure TMainFormAdmin.N3Click(Sender: TObject);
begin
 Form6.Show();
end;

procedure TMainFormAdmin.N5Click(Sender: TObject);
begin
...
procedure TMainFormAdmin.N9Click(Sender: TObject);
begin
DataModule2.Rep_frxDB_Q_Dez_month.ShowReport();
end;

procedure TMainFormAdmin.reccountEditChange(Sender: TObject);
begin
